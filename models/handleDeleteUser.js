...
// Delete a specific user from the database according to some criteria.
export const handleDeleteUser = async(documentClient, parameters) => {
    ...
    */
    return await documentClient.delete(parameters, (error, data) => {
        if (error) {
